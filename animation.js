...
function createScene() {
	...
	renderer.setClearColor(Colors.chineseBlack);
...
Boat = function () {
  ...
  var matHull = new THREE.MeshPhongMaterial({color:Colors.yellow, shading:THREE.FlatShading});
...
function updateBoat() {
	...
	var targetZ = normalize(mousePos.y, -1, 1, -50, 50);
		...
		// update the boat's position based on mouse location
	...
	//model.z += (targetZ - model.z)*0.01;
	//model.x += (targetX - model.x)*0.01;
